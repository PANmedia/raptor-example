...
<?php elseif ($type === 'include'): ?>
    <?php
        ...
        @include_once RAPTOR_FILE_MANAGER_DIR . 'src/include.php';
        @include_once RAPTOR_IMAGE_EDITOR_DIR . 'src/include.php';
        @include_once RAPTOR_PREMIUM_DIR . 'src/include.php';
        @include_once RAPTOR_SECTION_DIR . 'src/include.php';
    ?>
<?php endif; ?>
